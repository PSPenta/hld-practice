...
- [Circuit breaker](#circuit-breaker)
  ...
  - [Trip criteria (strategies)](#trip-criteria-strategies)
  - [Scope: what one breaker protects](#scope-what-one-breaker-protects)
  - [Use cases: Redis, DB, both](#use-cases-redis-db-both)
  - [How to implement](#how-to-implement)
  - [Fallbacks (pick per dependency)](#fallbacks-pick-per-dependency)
