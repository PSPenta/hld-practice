...
Hierarchical index of **every concept** under `docs/`. Jump by keyword; study order stays in [Docs index](./README.md).
...
_Built from `##` / `###` / `####` headings. If a link fails, see the [anchor rule](./README.md#format-convention-all-docs)._
